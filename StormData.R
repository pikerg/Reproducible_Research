...
## some basic questions about severe weather events. You must use the database to answer
## the questions below and show the code for your entire analysis. Your analysis can
## consist of tables, figures, or other summaries. You may use any R package you want to
...
##    * RStudio:
##        You will need RStudio to publish your completed analysis document to RPubs.
##        You can also use RStudio to edit/write your analysis.
##    * knitr:
##        You will need the knitr package in order to compile your R Markdown document
...
##    how the data were loaded into R and processed for analysis. In particular, your
##    analysis must start from the raw CSV file containing the data. You cannot do any
##    preprocessing outside the document. If preprocessing is time-consuming you may
